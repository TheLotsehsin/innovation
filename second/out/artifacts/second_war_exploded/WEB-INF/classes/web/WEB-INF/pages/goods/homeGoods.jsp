            ...
            <div class="nav-wrapper search-bar">
                <form class="ng-pristine ng-invalid ng-invalid-required" action="<%=basePath%>goods/search">
                    <div class="input-field">
                        <input id="search" name="str" placeholder="查询" style="height: 40px;"
                ...
                <c:if test="${!empty cur_user}">
                    <li class="publish-btn">
                        <button data-position="bottom" class="red lighten-1 waves-effect waves-light btn">
                            <a href="<%=basePath%>goods/publishGoods">发布商品</a>
                        </button>
                    </li>
                    <li>
                        <a href="<%=basePath%>user/allGoods">已发布的商品</a>
                    </li>
                    <li>
                    ...
                    <li class="changemore">
                        ...
                        <div class="more-vert">
                            <ul class="dropdown-content">
                                ...
                                <li><a href="<%=basePath%>admin" target="_blank">后台</a></li>
