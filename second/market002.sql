/*
 ...
 Source Schema         : market002

 Target Server Type    : MySQL
 Target Server Version : 80025
 File Encoding         : 65001

 Date: 27/05/2022 14:39:49
*/
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES (1, 'admin', 13177234070, '123456', '超级管理员');
...
CREATE TABLE `catelog`  (
  ...
  `number` int(0) NULL DEFAULT 0 COMMENT '该分类下的商品数量',
  `status` tinyint(0) NULL DEFAULT 0 COMMENT '分类状态，0正常，1暂用',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `catelog` VALUES (6, '运动棋牌', 6, 1);
...
CREATE TABLE `comments`  (
  ...
  `user_id` int(0) NULL DEFAULT NULL COMMENT '用户，外键',
  `goods_id` int(0) NULL DEFAULT NULL COMMENT '商品，外键',
...
INSERT INTO `comments` VALUES (130, 30, 80, '挺好', '2020-11-19 06:15:35');
INSERT INTO `comments` VALUES (131, 30, 80, '', '2020-11-19 06:15:41');
...
CREATE TABLE `focus`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `goods_id` int(0) NULL DEFAULT NULL COMMENT '外键 商品id',
  `user_id` int(0) NULL DEFAULT NULL COMMENT '外键 用户id',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `focus` VALUES (39, 110, 30);
INSERT INTO `focus` VALUES (40, 80, 30);
INSERT INTO `focus` VALUES (41, 124, 27);
...
CREATE TABLE `goods`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '商品主键',
  `catelog_id` int(0) NULL DEFAULT NULL COMMENT '商品分类，外键',
  `user_id` int(0) NULL DEFAULT NULL COMMENT '用户外键',
  ...
  `status` int(0) NULL DEFAULT 1 COMMENT '状态 上架1 下架0',
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of goods
-- ----------------------------
INSERT INTO `goods` VALUES (1, 6, 1, '吉他', 130.00, 160.00, '2020-05-21', '2017-05-13', '2017-05-23', '八成新', 1);
INSERT INTO `goods` VALUES (8, 3, 1, '台灯', 50.00, 25.00, '2020-04-30', '2017-05-14', '2017-05-24', '半价出售', 0);
INSERT INTO `goods` VALUES (13, 5, 1, '手提包', 100.00, 45.00, '2020-05-14', '2017-05-14', '2017-05-24', '', 1);
INSERT INTO `goods` VALUES (20, 1, 4, '笔记本', 2500.00, 2300.00, '2020-05-14', '2017-05-14', '2017-05-24', '八成新，可打游戏', 0);
INSERT INTO `goods` VALUES (80, 1, 4, '苹果iphone6', 3488.00, 1888.00, '2020-04-14', '2018-04-14', '2018-04-24', '', 0);
INSERT INTO `goods` VALUES (86, 7, 7, '吉他吉他', 1588.00, 1200.00, '2020-04-14', '2018-04-14', '2018-04-24', '', 1);
INSERT INTO `goods` VALUES (88, 6, 9, '运动器材', 150.00, 100.00, '2020-04-14', '2018-04-14', '2018-04-24', '无', 1);
INSERT INTO `goods` VALUES (93, 5, 10, '一只小帽子', 34.00, 25.00, '2020-04-22', '2018-04-14', '2018-04-24', '非全新', 0);
INSERT INTO `goods` VALUES (94, 3, 1, '烧水壶', 55.00, 22.00, '2020-04-14', '2018-04-14', '2018-04-24', '九成新，可降价', 1);
INSERT INTO `goods` VALUES (103, 1, 22, '排球', 68.00, 59.00, '2020-0429', '2018-04-22', '2018-05-02', '无', 1);
INSERT INTO `goods` VALUES (110, 4, 23, '一本好书', 27.00, 17.00, '2020-05-07', '2018-05-07', '2018-05-17', '不可多得 一本好书', 1);
INSERT INTO `goods` VALUES (111, 4, 23, '仓央嘉措好书', 33.00, 20.00, '2020-05-07', '2018-05-07', '2018-05-17', '诗人仓央嘉措的书，很美。', 0);
INSERT INTO `goods` VALUES (124, 1, 31, '红米6pro', 100.00, 999.00, '2020-12-17', '2020-12-17', '2020-12-27', '红米6pro', 1);
INSERT INTO `goods` VALUES (125, 1, 31, '苹果X11', 3999.00, 6999.00, '2020-12-17', '2020-12-17', '2020-12-27', '苹果X11', 1);
INSERT INTO `goods` VALUES (126, 1, 31, '苹果X11', 3999.00, 6999.00, '2020-12-17', '2020-12-17', '2020-12-27', '苹果X11', 1);
INSERT INTO `goods` VALUES (127, 1, 31, '苹果X12', 2999.00, 7980.00, '2020-12-17', '2020-12-17', '2020-12-27', '苹果X12', 1);
INSERT INTO `goods` VALUES (128, 1, 31, '苹果X11九成新', 2000.00, 6980.00, '2020-12-17', '2020-12-17', '2020-12-27', '苹果X11九成新', 1);
...
CREATE TABLE `image`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '图片主键',
  `goods_id` int(0) NOT NULL COMMENT '商品外键',
...
INSERT INTO `image` VALUES (118, 118, '5f58bfca-4cf4-45fb-ad6e-fb9586c53ef3.jpg');
INSERT INTO `image` VALUES (119, 119, 'd33efd96-84d2-4e1f-bd39-257d7d08fc7d.jpg');
INSERT INTO `image` VALUES (120, 120, '95a53642-94a3-4ca3-bb9f-fae9f45dbdff.jpg');
INSERT INTO `image` VALUES (121, 121, 'b06935e5-ed0b-4de7-a60e-51d4bac29096.jpg');
INSERT INTO `image` VALUES (122, 122, '');
INSERT INTO `image` VALUES (123, 123, '');
INSERT INTO `image` VALUES (124, 124, '8987442d-9233-43f4-8805-6f213dc259f3.jpg');
INSERT INTO `image` VALUES (125, 125, '18c4814d-f420-48c0-86d4-e030ca430173.jpg');
INSERT INTO `image` VALUES (126, 126, '18c4814d-f420-48c0-86d4-e030ca430173.jpg');
INSERT INTO `image` VALUES (127, 127, 'f63ceab6-9cca-49c8-971a-7e6e315c13ac.jpg');
INSERT INTO `image` VALUES (128, 128, 'eec8cb1f-fa8a-4da3-8d83-b776f829db12.jpg');
...
CREATE TABLE `notice`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '系统信息主键',
  `user_id` int(0) NULL DEFAULT NULL COMMENT '用户，外键',
  ...
  `status` tinyint(0) NULL DEFAULT NULL COMMENT '状态，0未读，1已读',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `orders`  (
  ...
  `order_num` bigint(0) NULL DEFAULT NULL COMMENT '订单编号',
  `order_price` float(11, 0) NULL DEFAULT NULL COMMENT '订单价格',
  `order_state` int(0) NULL DEFAULT 1 COMMENT '订单状态 1待发货 2待收货 3已完成',
...
-- Records of orders
-- ----------------------------
INSERT INTO `orders` VALUES (23, 31, 110, 89201862, 27, 3, '', '2020-12-17 01:45:10');
...
CREATE TABLE `purse`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '钱包id',
  `user_id` int(0) NOT NULL COMMENT '用户id',
  ...
  `state` int(0) NULL DEFAULT NULL COMMENT '状态 0未审核   已审核（1不通过 2通过）',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of purse
-- ----------------------------
INSERT INTO `purse` VALUES (1, 1, 00000001063, NULL, NULL, NULL);
...
INSERT INTO `purse` VALUES (18, 23, 00000001168, NULL, NULL, NULL);
...
INSERT INTO `purse` VALUES (22, 27, 00000009425, 100, NULL, 0);
INSERT INTO `purse` VALUES (23, 28, 00000000000, NULL, NULL, NULL);
INSERT INTO `purse` VALUES (24, 29, 00000000000, NULL, NULL, NULL);
INSERT INTO `purse` VALUES (25, 30, 00000000344, NULL, NULL, 2);
INSERT INTO `purse` VALUES (26, 31, 00000000003, NULL, NULL, NULL);
...
CREATE TABLE `reply`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '评论回复主键',
  `user_id` int(0) NULL DEFAULT NULL COMMENT '用户，外键',
  `atuser_id` int(0) NULL DEFAULT NULL,
  `commet_id` int(0) NULL DEFAULT NULL COMMENT '评论，外键',
...
CREATE TABLE `user`  (
  ...
  `goods_num` int(0) NULL DEFAULT 0 COMMENT '发布过的物品数量',
  ...
  `status` tinyint(0) NULL DEFAULT 0 COMMENT '账号是否冻结，默认0未冻结',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (23, '13177234070', '小丽', 'E10ADC3949BA59ABBE56E057F20F883E', '357598890', '2018-04-22 12:25', 7, 0000000100, NULL, 0);
INSERT INTO `user` VALUES (27, '15565782770', '阿姬', 'E10ADC3949BA59ABBE56E057F20F883E', NULL, '2020-06-01 16:16', 5, 0000000100, NULL, 1);
INSERT INTO `user` VALUES (29, '13888888888', '13888888888', 'E10ADC3949BA59ABBE56E057F20F883E', NULL, '2020-07-13 09:51', 0, 0000000100, NULL, 1);
INSERT INTO `user` VALUES (30, '17824824063', 'passion', 'E10ADC3949BA59ABBE56E057F20F883E', '1941863677', '2020-11-19 14:33', 1, 0000000100, NULL, 1);
INSERT INTO `user` VALUES (31, '17824824023', '张三', 'E10ADC3949BA59ABBE56E057F20F883E', NULL, '2020-12-15 21:45', 5, 0000000100, NULL, 1);
